...
public interface Component {
	...
	public final static class ParamWrapper<E extends Enum<E>>
			extends ControlFlowContent {
		...
		public static <E extends Enum<E>> ParamWrapper<E> wrap( Content body,
				Class<E> paramEnumClass ) {
	...
	public static class TestComponent
			implements Content, Out<Integer> {
		...
		public static Content getInstance( Source<Integer> foo, Source<List<String>> bar ) {
			return ParamWrapper.wrap( BODY_TEMPLATE_A, MyTestParams.class ).bind( FOO_PARAM, foo ).bind(
					BAR_PARAM, bar );
		}
