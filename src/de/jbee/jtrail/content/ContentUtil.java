...
public class ContentUtil {
	...
	private static class ForEachContent<T>
			implements Content {
	 ...
	 * und
	 */
	public static <T> Content forEach( final Data<Iterable<T>> entries,
			final Out<? super T>... body ) {
	...
	public static Content ifThenElse( final Data<Boolean> condition, final Content thanBody,
			final Content elseBody ) {

		return null;
	}

	// TODO Map<T, Content> durch eine Klasse ersetzen, die dies umsetzt
	public static <T> Content switchOf( final Data<T> value, final Map<T, Content> cases,
			final Content defaultCase ) {
